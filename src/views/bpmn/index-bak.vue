...
<style lang="scss">
  @import "../../styles/bpmn/diagram-js.css";
  @import "../../styles/bpmn/bpmn-embedded.css";
.bpmn-views{
  position: relative;
}
  .content,
  ...
  .bpp-properties-panel label, .bpp-properties-panel input {
    vertical-align: middle;
  }
  /* line 29, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-properties-panel input, .bpp-properties-panel button, .bpp-properties-panel textarea, .bpp-properties-panel[contenteditable] {
    padding: 3px 6px;
    border: 1px solid #ccc;
  }
  /* line 36, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-properties-panel input:focus, .bpp-properties-panel button:focus, .bpp-properties-panel textarea:focus, .bpp-properties-panel[contenteditable]:focus {
    outline: none;
    border-color: #52B415;
    box-shadow: 0 0 1px 2px rgba(82, 180, 21, 0.2);
  }
  /* line 40, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-properties-panel input.invalid, .bpp-properties-panel button.invalid, .bpp-properties-panel textarea.invalid, .bpp-properties-panel[contenteditable].invalid {
    border-color: #cc3333;
    background: #f0c2c2;
  }
  /* line 42, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-properties-panel input.invalid:focus, .bpp-properties-panel button.invalid:focus, .bpp-properties-panel textarea.invalid:focus, .bpp-properties-panel[contenteditable].invalid:focus {
  ...
  .bpp-properties-panel[contenteditable], .bpp-properties-panel textarea {
    resize: vertical;
  }
  ...
  .bpp-error-message, .bpp-error-message.bpp-entry-link {
    margin-top: 5px;
    color: #cc3333;
  }
  ...
  .bpp-radios-group input, .bpp-radios-group label {
    vertical-align: middle;
  }
  ...
  .bpp-radios-group label:after, .bpp-checkbox label:after {
    display: none;
  }
  ...
  .bpp-select button.add, .bpp-element-list button.add, .bpp-select button.clear, .bpp-element-list button.clear {
    top: -23px;
    border-bottom: none;
  }
  /* line 202, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-select button.add, .bpp-element-list button.add {
    right: 0px;
  }
  /* line 206, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-select button.clear, .bpp-element-list button.clear {
    right: 23px;
  }
  ...
  .bpp-table-row > input, .bpp-table-row > button {
    float: left;
  }
  ...
  .bpp-table-row > label.bpp-table-row-columns-1, .bpp-table-row > input.bpp-table-row-columns-1 {
    width: 100%;
  }
  /* line 264, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-table-row > label.bpp-table-row-columns-1.bpp-table-row-removable, .bpp-table-row > input.bpp-table-row-columns-1.bpp-table-row-removable {
    width: calc(100% - 24px);
  }
  /* line 269, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-table-row > label.bpp-table-row-columns-2, .bpp-table-row > input.bpp-table-row-columns-2 {
    width: 50%;
  }
  /* line 271, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-table-row > label.bpp-table-row-columns-2.bpp-table-row-removable, .bpp-table-row > input.bpp-table-row-columns-2.bpp-table-row-removable {
    width: calc(50% - 12px);
  }
  /* line 274, node_modules\bpmn-js-properties-panel\styles\properties.less */
  .bpp-table-row > label.bpp-table-row-columns-2:nth-child(2), .bpp-table-row > input.bpp-table-row-columns-2:nth-child(2) {
    border-left: none;
  }
  ...
  .bpp-properties-tab, .bpp-properties-tab.bpp-hidden {
    display: none;
  }
